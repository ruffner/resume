...
\denseouterlist{
\entry{\textbf{Embedded/Desktop Programming: } 6 years experience with C/C++ and Qt. Proficient in Python, MATLAB and \LaTeX.  Very quick to learn new APIs and software. Comfortable with Linux/OSX/Windows as daily driver.}

\entry{\textbf{Linux: } 11 years experience. Proficient with Git, Emacs, and Make. Comfortable on a CLI as well as using Bash scripts, dotfiles and aliases to expedite routine workflows.}
